CREATE TABLE IF NOT EXISTS `dtu`.`thresholded_edges_75db_60per_participation` (
...
TRUNCATE TABLE `dtu`.`thresholded_edges_75db_60per_participation`;

INSERT INTO
	`dtu`.`thresholded_edges_75db_60per_participation` (
		`timestamp`,
		`src`,
		`trg`
	)
